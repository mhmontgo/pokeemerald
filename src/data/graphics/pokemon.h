...
const u32 gMonStillFrontPic_Crylem[] = INCBIN_U32("graphics/pokemon/crylem/front.4bpp.lz");
const u32 gMonPalette_Crylem[] = INCBIN_U32("graphics/pokemon/crylem/normal.gbapal.lz");
const u32 gMonBackPic_Crylem[] = INCBIN_U32("graphics/pokemon/crylem/back.4bpp.lz");
const u32 gMonShinyPalette_Crylem[] = INCBIN_U32("graphics/pokemon/crylem/shiny.gbapal.lz");
const u8 gMonIcon_Crylem[] = INCBIN_U8("graphics/pokemon/crylem/icon.4bpp");
const u8 gMonFootprint_Crylem[] = INCBIN_U8("graphics/pokemon/crylem/footprint.1bpp");
